...
\begin{enumerate}
    ...
    \end{itemize}
    \item Furthermore we shall be referncing the following papers that have achieved implemented object recognition through deep learning using Yolov8 and other Models:
    \begin{itemize}
